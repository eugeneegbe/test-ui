...
<html lang="en">
<head>
    <title>Code coverage report for src/windows.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> windows.js
    </h1>
    <div class='clearfix'>
...
OO.ui.prompt = function ( text, options ) {
	var instance,
		...
		textInput = new OO.ui.TextInputWidget( ( options &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >options.textInput </span>) || {} ),
...
&nbsp;
	...
	instance.opened.then( function () {
		textInput.on( 'enter', <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >			manager.getCurrentWindow().close( { action: 'accept' } );</span>
		} );
		textInput.focus();
	} );
&nbsp;
