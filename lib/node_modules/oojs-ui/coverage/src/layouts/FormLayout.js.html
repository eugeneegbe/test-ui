...
<html lang="en">
<head>
    <title>Code coverage report for src/layouts/FormLayout.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/layouts/</a> FormLayout.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
	...
	<span class="missing-if-branch" title="if path not taken" >I</span>if ( action !== undefined &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!OO.ui.isSafeUrl( action ) </span>) {
 ...
 * @fires submit
 */
OO.ui.FormLayout.prototype.onFormSubmit = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >	if ( this.emit( 'submit' ) ) {</span>
