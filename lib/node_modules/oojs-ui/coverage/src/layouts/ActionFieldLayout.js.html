...
<html lang="en">
<head>
    <title>Code coverage report for src/layouts/ActionFieldLayout.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/layouts/</a> ActionFieldLayout.js
    </h1>
    <div class='clearfix'>
...
OO.ui.ActionFieldLayout = function OoUiActionFieldLayout( fieldWidget, buttonWidget, config ) {
	...
	<span class="missing-if-branch" title="else path not taken" >E</span>if ( OO.isPlainObject( fieldWidget ) &amp;&amp; config === undefined ) {
		config = fieldWidget;
