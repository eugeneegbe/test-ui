...
<html lang="en">
<head>
    <title>Code coverage report for src/Window.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> Window.js
    </h1>
    <div class='clearfix'>
...
683
684
685</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
 ...
 */
OO.ui.Window.prototype.onMouseDown = <span class="fstat-no" title="function not covered" >function ( e ) {</span>
	// Prevent clicking on the click-block from stealing focus
<span class="cstat-no" title="statement not covered" >	if ( e.target === this.$element[ 0 ] ) {</span>
 ...
 */
OO.ui.Window.prototype.isInitialized = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >	return !!this.manager;</span>
};
&nbsp;
/**
 ...
 */
OO.ui.Window.prototype.isOpened = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >	return this.manager.isOpened( this );</span>
};
&nbsp;
/**
 ...
 */
OO.ui.Window.prototype.getManager = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >	return this.manager;</span>
};
&nbsp;
/**
...
OO.ui.Window.prototype.getSize = function () {
	var viewport = OO.ui.Element.static.getDimensions( this.getElementWindow() ),
		...
		size = this.size;
&nbsp;
	<span class="missing-if-branch" title="if path not taken" >I</span>if ( !sizes[ size ] ) {
<span class="cstat-no" title="statement not covered" >		size = this.manager.constructor.static.defaultSize;</span>
	}
	<span class="missing-if-branch" title="if path not taken" >I</span>if ( size !== 'full' &amp;&amp; viewport.rect.right - viewport.rect.left &lt; sizes[ size ].width ) {
<span class="cstat-no" title="statement not covered" >		size = 'full';</span>
	}
&nbsp;
	return size;
};
 ...
 */
OO.ui.Window.prototype.getBodyHeight = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >	return this.$body[ 0 ].scrollHeight;</span>
};
&nbsp;
/**
 ...
 */
OO.ui.Window.prototype.getDir = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >	return OO.ui.Element.static.getDir( this.$content ) || 'ltr';</span>
};
&nbsp;
/**
...
OO.ui.Window.prototype.setManager = function ( manager ) {
	<span class="missing-if-branch" title="if path not taken" >I</span>if ( this.manager ) {
<span class="cstat-no" title="statement not covered" >		throw new Error( 'Cannot set window manager, window already has a manager' );</span>
	}
&nbsp;
 ...
 * @chainable
 */
OO.ui.Window.prototype.setSize = <span class="fstat-no" title="function not covered" >function ( size ) {</span>
...
OO.ui.Window.prototype.updateSize = function () {
	<span class="missing-if-branch" title="if path not taken" >I</span>if ( !this.manager ) {
<span class="cstat-no" title="statement not covered" >		throw new Error( 'Cannot update window size, must be attached to a manager' );</span>
	}
&nbsp;
...
&nbsp;
	...
	<span class="missing-if-branch" title="else path not taken" >E</span>if ( dim.height === undefined ) {
		this.withoutSizeTransitions( function () {
			var oldWidth = styleObj.width;
			win.$frame.css( 'width', dim.width || <span class="branch-1 cbranch-no" title="branch not covered" >'' </span>);
			height = win.getContentHeight();
			styleObj.width = oldWidth;
		} );
	} else {
<span class="cstat-no" title="statement not covered" >		height = dim.height;</span>
	}
&nbsp;
	this.$frame.css( {
		width: dim.width || <span class="branch-1 cbranch-no" title="branch not covered" >'',</span>
		minWidth: dim.minWidth || '',
		maxWidth: dim.maxWidth || '',
		height: height || <span class="branch-1 cbranch-no" title="branch not covered" >'',</span>
...
OO.ui.Window.prototype.initialize = function () {
	<span class="missing-if-branch" title="if path not taken" >I</span>if ( !this.manager ) {
<span class="cstat-no" title="statement not covered" >		throw new Error( 'Cannot initialize window, must be attached to a manager' );</span>
	}
&nbsp;
	// Properties
	this.$head = $( '&lt;div&gt;' );
 ...
 */
OO.ui.Window.prototype.onFocusTrapFocused = <span class="fstat-no" title="function not covered" >function ( event ) {</span>
<span class="cstat-no" title="statement not covered" >	var backwards = this.$focusTrapBefore.is( event.target ),</span>
...
<span class="cstat-no" title="statement not covered" >		this.$content.focus();</span>
	}
};
&nbsp;
/**
 ...
 * @throws {Error} An error is thrown if the window is not attached to a window manager
 */
OO.ui.Window.prototype.open = <span class="fstat-no" title="function not covered" >function ( data ) {</span>
<span class="cstat-no" title="statement not covered" >	if ( !this.manager ) {</span>
<span class="cstat-no" title="statement not covered" >		throw new Error( 'Cannot open window, must be attached to a manager' );</span>
	}
&nbsp;
<span class="cstat-no" title="statement not covered" >	return this.manager.openWindow( this, data );</span>
};
&nbsp;
/**
 * Close the window.
...
OO.ui.Window.prototype.close = function ( data ) {
	<span class="missing-if-branch" title="if path not taken" >I</span>if ( !this.manager ) {
<span class="cstat-no" title="statement not covered" >		throw new Error( 'Cannot close window, must be attached to a manager' );</span>
	}
&nbsp;
...
&nbsp;
		...
		<span class="missing-if-branch" title="else path not taken" >E</span>if ( $focus.length ) {
			$focus[ 0 ].blur();
		}
&nbsp;
		// Force redraw by asking the browser to measure the elements' widths
