...
<html lang="en">
<head>
    <title>Code coverage report for src/toolgroups/BarToolGroup.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/toolgroups/</a> BarToolGroup.js
    </h1>
    <div class='clearfix'>
 ...
 */
OO.ui.BarToolGroup = <span class="fstat-no" title="function not covered" >function OoUiBarToolGroup( toolbar, config ) {</span>
...
&nbsp;
	// Parent constructor
<span class="cstat-no" title="statement not covered" >	OO.ui.BarToolGroup.parent.call( this, toolbar, config );</span>
&nbsp;
	// Initialization
<span class="cstat-no" title="statement not covered" >	this.$element.addClass( 'oo-ui-barToolGroup' );</span>
<span class="cstat-no" title="statement not covered" >	this.$group.addClass( 'oo-ui-barToolGroup-tools' );</span>
};
&nbsp;
/* Setup */
&nbsp;
