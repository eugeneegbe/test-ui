...
<html lang="en">
<head>
    <title>Code coverage report for src/toolgroups/MenuToolGroup.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/toolgroups/</a> MenuToolGroup.js
    </h1>
    <div class='clearfix'>
 ...
 */
OO.ui.MenuToolGroup = <span class="fstat-no" title="function not covered" >function OoUiMenuToolGroup( toolbar, config ) {</span>
...
&nbsp;
	// Parent constructor
<span class="cstat-no" title="statement not covered" >	OO.ui.MenuToolGroup.parent.call( this, toolbar, config );</span>
&nbsp;
	// Events
<span class="cstat-no" title="statement not covered" >	this.toolbar.connect( this, { updateState: 'onUpdateState' } );</span>
&nbsp;
	// Initialization
<span class="cstat-no" title="statement not covered" >	this.$element.addClass( 'oo-ui-menuToolGroup' );</span>
<span class="cstat-no" title="statement not covered" >	this.$group.addClass( 'oo-ui-menuToolGroup-tools' );</span>
};
&nbsp;
/* Setup */
&nbsp;
 ...
 * @private
 */
OO.ui.MenuToolGroup.prototype.onUpdateState = <span class="fstat-no" title="function not covered" >function () {</span>
...
<span class="cstat-no" title="statement not covered" >		if ( this.tools[ name ].isActive() ) {</span>
<span class="cstat-no" title="statement not covered" >			labelTexts.push( this.tools[ name ].getTitle() );</span>
		}
	}
&nbsp;
<span class="cstat-no" title="statement not covered" >	this.setLabel( labelTexts.join( ', ' ) || ' ' );</span>
};
&nbsp;</pre></td></tr>
</table></pre>
