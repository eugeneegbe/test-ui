...
<html lang="en">
<head>
    <title>Code coverage report for src/Process.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> Process.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
			...
			if ( typeof result === 'number' ) {
				<span class="missing-if-branch" title="if path not taken" >I</span>if ( result &lt; 0 ) {
<span class="cstat-no" title="statement not covered" >					throw new Error( 'Cannot go back in time: flux capacitor is out of service' );</span>
				}
			...
			<span class="missing-if-branch" title="if path not taken" >I</span>if ( result instanceof OO.ui.Error ) {
				// Use rejected promise for error
<span class="cstat-no" title="statement not covered" >				return $.Deferred().reject( [ result ] ).promise();</span>
			}
			<span class="missing-if-branch" title="if path not taken" >I</span>if ( Array.isArray( result ) &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >result.length </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >result[ 0 ] instanceof OO.ui.Error </span>) {
...
OO.ui.Process.prototype.createStep = function ( step, context ) {
	<span class="missing-if-branch" title="if path not taken" >I</span>if ( typeof step === 'number' || $.isFunction( step.promise ) ) {
...
<span class="cstat-no" title="statement not covered" >				return step;</span>
	...
	<span class="missing-if-branch" title="else path not taken" >E</span>if ( $.isFunction( step ) ) {
		return {
			callback: step,
			context: context
		};
	}
<span class="cstat-no" title="statement not covered" >	throw new Error( 'Cannot create process step: number, promise or function expected' );</span>
};
&nbsp;
/**
