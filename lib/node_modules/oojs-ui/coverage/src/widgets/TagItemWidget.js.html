...
<html lang="en">
<head>
    <title>Code coverage report for src/widgets/TagItemWidget.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/widgets/</a> TagItemWidget.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">58.33% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>42/72</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
	this.valid = config.valid === undefined ? true : <span class="branch-1 cbranch-no" title="branch not covered" >!!config.valid;</span>
...
&nbsp;
	...
	this.$element
		...
		.on( 'mousedown', <span class="fstat-no" title="function not covered" >function ( e ) {</span> <span class="cstat-no" title="statement not covered" >e.stopPropagation(); </span>} );
&nbsp;
	// Initialization
	this.$element
 ...
 * @fires fixed
 */
OO.ui.TagItemWidget.prototype.setFixed = <span class="fstat-no" title="function not covered" >function ( state ) {</span>
<span class="cstat-no" title="statement not covered" >	state = state === undefined ? !this.fixed : !!state;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >	if ( this.fixed !== state ) {</span>
<span class="cstat-no" title="statement not covered" >		this.fixed = state;</span>
<span class="cstat-no" title="statement not covered" >		if ( this.closeButton ) {</span>
<span class="cstat-no" title="statement not covered" >			this.closeButton.toggle( !this.fixed );</span>
		}
&nbsp;
<span class="cstat-no" title="statement not covered" >		if ( !this.fixed &amp;&amp; this.elementGroup &amp;&amp; !this.elementGroup.isDraggable() ) {</span>
			// Only enable the state of the item if the
			// entire group is draggable
<span class="cstat-no" title="statement not covered" >			this.toggleDraggable( !this.fixed );</span>
		}
<span class="cstat-no" title="statement not covered" >		this.$element.toggleClass( 'oo-ui-tagItemWidget-fixed', this.fixed );</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >		this.emit( 'fixed', this.isFixed() );</span>
	}
...
OO.ui.TagItemWidget.prototype.setDisabled = function ( state ) {
	<span class="missing-if-branch" title="if path not taken" >I</span>if ( state &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.elementGroup </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >!this.elementGroup.isDisabled() </span>) {
<span class="cstat-no" title="statement not covered" >		OO.ui.warnDeprecation( 'TagItemWidget#setDisabled: Disabling individual items is deprecated and will result in inconsistent behavior. Use #setFixed instead. See T193571.' );</span>
	}
	// Parent method
	...
	<span class="missing-if-branch" title="if path not taken" >I</span>if (
		...
		// item is not fixed
<span class="cstat-no" title="statement not covered" >		this.toggleDraggable( !state );</span>
	}
&nbsp;
	if ( this.closeButton ) {
 ...
 * @fires remove
 */
OO.ui.TagItemWidget.prototype.remove = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >	if ( !this.isDisabled() ) {</span>
<span class="cstat-no" title="statement not covered" >		this.emit( 'remove' );</span>
	}
};
&nbsp;
/**
 ...
 */
OO.ui.TagItemWidget.prototype.onKeyDown = <span class="fstat-no" title="function not covered" >function ( e ) {</span>
<span class="cstat-no" title="statement not covered" >	var movement;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >	if ( !this.isDisabled() &amp;&amp; !this.isFixed() &amp;&amp; e.keyCode === OO.ui.Keys.BACKSPACE || e.keyCode === OO.ui.Keys.DELETE ) {</span>
<span class="cstat-no" title="statement not covered" >		this.remove();</span>
<span class="cstat-no" title="statement not covered" >		return false;</span>
	} else <span class="cstat-no" title="statement not covered" >if ( e.keyCode === OO.ui.Keys.ENTER ) {</span>
 ...
 * @fires select
 */
OO.ui.TagItemWidget.prototype.select = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >	if ( !this.isDisabled() ) {</span>
<span class="cstat-no" title="statement not covered" >		this.emit( 'select' );</span>
	}
};
&nbsp;
/**
