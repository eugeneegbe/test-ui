...
<html lang="en">
<head>
    <title>Code coverage report for src/widgets/CheckboxMultiselectInputWidget.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/widgets/</a> CheckboxMultiselectInputWidget.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">3184×</span>
<span class="cline-any cline-yes">3184×</span>
<span class="cline-any cline-yes">3184×</span>
<span class="cline-any cline-yes">3184×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">6368×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">6368×</span>
<span class="cline-any cline-yes">796×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
OO.ui.CheckboxMultiselectInputWidget.static.gatherPreInfuseState = function ( node, config ) {
	...
	state.value = $( node ).find( '.oo-ui-checkboxInputWidget .oo-ui-inputWidget-input:checked' )
		.toArray().map( <span class="fstat-no" title="function not covered" >function ( el ) {</span> <span class="cstat-no" title="statement not covered" >return el.value; </span>} );
	return state;
};
&nbsp;
/**
 ...
 * @private
 */
OO.ui.CheckboxMultiselectInputWidget.prototype.onCheckboxesSelect = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >	this.setValue( this.checkboxMultiselectWidget.findSelectedItemsData() );</span>
};
&nbsp;
/**
 * @inheritdoc
...
OO.ui.CheckboxMultiselectInputWidget.prototype.getValue = function () {
	var value = this.$element.find( '.oo-ui-checkboxInputWidget .oo-ui-inputWidget-input:checked' )
		.toArray().map( <span class="fstat-no" title="function not covered" >function ( el ) {</span> <span class="cstat-no" title="statement not covered" >return el.value; </span>} );
	<span class="missing-if-branch" title="else path not taken" >E</span>if ( this.value !== value ) {
		this.setValue( value );
	}
	return this.value;
};
...
<span class="cstat-no" title="statement not covered" >		singleValue =</span>
			OO.ui.CheckboxMultiselectInputWidget.parent.prototype.cleanUpValue.call( this, value[ i ] );
		// Remove options that we don't have here
<span class="cstat-no" title="statement not covered" >		if ( !this.checkboxMultiselectWidget.findItemFromData( singleValue ) ) {</span>
<span class="cstat-no" title="statement not covered" >			continue;</span>
		}
<span class="cstat-no" title="statement not covered" >		cleanValue.push( singleValue );</span>
	}
	return cleanValue;
};
&nbsp;
 ...
 * @chainable
 */
OO.ui.CheckboxMultiselectInputWidget.prototype.setOptions = <span class="fstat-no" title="function not covered" >function ( options ) {</span>
 ...
 * @inheritdoc
 */
OO.ui.CheckboxMultiselectInputWidget.prototype.focus = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >	this.checkboxMultiselectWidget.focus();</span>
<span class="cstat-no" title="statement not covered" >	return this;</span>
};
&nbsp;</pre></td></tr>
</table></pre>
