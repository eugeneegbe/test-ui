...
<html lang="en">
<head>
    <title>Code coverage report for src/widgets/ActionWidget.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/widgets/</a> ActionWidget.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
	// Properties
	this.action = config.action || <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
 ...
 */
OO.ui.ActionWidget.prototype.hasMode = <span class="fstat-no" title="function not covered" >function ( mode ) {</span>
<span class="cstat-no" title="statement not covered" >	return this.modes.indexOf( mode ) !== -1;</span>
};
&nbsp;
/**
