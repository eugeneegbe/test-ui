...
<html lang="en">
<head>
    <title>Code coverage report for src/widgets/CheckboxMultioptionWidget.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/widgets/</a> CheckboxMultioptionWidget.js
    </h1>
    <div class='clearfix'>
 ...
 * Focus the widget.
 */
OO.ui.CheckboxMultioptionWidget.prototype.focus = <span class="fstat-no" title="function not covered" >function () {</span>
 ...
 */
OO.ui.CheckboxMultioptionWidget.prototype.onKeyDown = <span class="fstat-no" title="function not covered" >function ( e ) {</span>
<span class="cstat-no" title="statement not covered" >	var</span>
		element = this.getElementGroup(),
		nextItem;
&nbsp;
<span class="cstat-no" title="statement not covered" >	if ( e.keyCode === OO.ui.Keys.LEFT || e.keyCode === OO.ui.Keys.UP ) {</span>
<span class="cstat-no" title="statement not covered" >		nextItem = element.getRelativeFocusableItem( this, -1 );</span>
	} else <span class="cstat-no" title="statement not covered" >if ( e.keyCode === OO.ui.Keys.RIGHT || e.keyCode === OO.ui.Keys.DOWN ) {</span>
<span class="cstat-no" title="statement not covered" >		nextItem = element.getRelativeFocusableItem( this, 1 );</span>
	}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >		nextItem.focus();</span>
	}
};
&nbsp;</pre></td></tr>
</table></pre>
