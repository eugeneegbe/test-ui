...
<html lang="en">
<head>
    <title>Code coverage report for src/widgets/CheckboxInputWidget.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/widgets/</a> CheckboxInputWidget.js
    </h1>
    <div class='clearfix'>
 ...
 * @inheritdoc
 */
OO.ui.CheckboxInputWidget.prototype.onEdit = <span class="fstat-no" title="function not covered" >function () {</span>
...
<span class="cstat-no" title="statement not covered" >			widget.setSelected( widget.$input.prop( 'checked' ) );</span>
		} );
	}
};
&nbsp;
...
OO.ui.CheckboxInputWidget.prototype.isSelected = function () {
	...
	<span class="missing-if-branch" title="if path not taken" >I</span>if ( this.selected !== selected ) {
<span class="cstat-no" title="statement not covered" >		this.setSelected( selected );</span>
	}
 ...
 * @inheritdoc
 */
OO.ui.CheckboxInputWidget.prototype.simulateLabelClick = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >	if ( !this.isDisabled() ) {</span>
...
OO.ui.CheckboxInputWidget.prototype.restorePreInfuseState = function ( state ) {
	...
	<span class="missing-if-branch" title="if path not taken" >I</span>if ( state.checked !== undefined &amp;&amp; state.checked !== this.isSelected() ) {
<span class="cstat-no" title="statement not covered" >		this.setSelected( state.checked );</span>
	}
};
&nbsp;</pre></td></tr>
</table></pre>
