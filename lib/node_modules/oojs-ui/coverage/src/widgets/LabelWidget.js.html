...
<html lang="en">
<head>
    <title>Code coverage report for src/widgets/LabelWidget.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/widgets/</a> LabelWidget.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
	// Initialization
	if ( this.input ) {
		<span class="missing-if-branch" title="else path not taken" >E</span>if ( this.input.getInputId() ) {
			this.$element.attr( 'for', this.input.getInputId() );
		} else {
<span class="cstat-no" title="statement not covered" >			this.$label.on( 'click', <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >				this.input.simulateLabelClick();</span>
			}.bind( this ) );
		}
	}
