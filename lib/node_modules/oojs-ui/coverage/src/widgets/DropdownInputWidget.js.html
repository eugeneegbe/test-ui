...
<html lang="en">
<head>
    <title>Code coverage report for src/widgets/DropdownInputWidget.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/widgets/</a> DropdownInputWidget.js
    </h1>
    <div class='clearfix'>
 ...
 */
OO.ui.DropdownInputWidget.prototype.onMenuSelect = <span class="fstat-no" title="function not covered" >function ( item ) {</span>
<span class="cstat-no" title="statement not covered" >	this.setValue( item ? item.getData() : '' );</span>
};
&nbsp;
/**
 * @inheritdoc
 ...
 * @chainable
 */
OO.ui.DropdownInputWidget.prototype.setOptions = <span class="fstat-no" title="function not covered" >function ( options ) {</span>
<span class="cstat-no" title="statement not covered" >	var value = this.getValue();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >	this.setOptionsData( options );</span>
&nbsp;
...
&nbsp;
	optionWidgets = options.map( function ( opt ) {
		var optValue;
&nbsp;
		<span class="missing-if-branch" title="if path not taken" >I</span>if ( opt.optgroup !== undefined ) {
<span class="cstat-no" title="statement not covered" >			return widget.createMenuSectionOptionWidget( opt.optgroup );</span>
		}
&nbsp;
 ...
 */
OO.ui.DropdownInputWidget.prototype.createMenuSectionOptionWidget = <span class="fstat-no" title="function not covered" >function ( label ) {</span>
<span class="cstat-no" title="statement not covered" >	return new OO.ui.MenuSectionOptionWidget( {</span>
		label: label
	} );
};
&nbsp;
...
&nbsp;
	this.dropdownWidget.getMenu().getItems().forEach( function ( optionWidget ) {
		var $optionNode;
&nbsp;
		<span class="missing-if-branch" title="else path not taken" >E</span>if ( !( optionWidget instanceof OO.ui.MenuSectionOptionWidget ) ) {
			$optionNode = $( '&lt;option&gt;' )
...
<span class="cstat-no" title="statement not covered" >			$optionNode = $( '&lt;optgroup&gt;' )</span>
				.attr( 'label', optionWidget.getLabel() );
<span class="cstat-no" title="statement not covered" >			widget.$input.append( $optionNode );</span>
<span class="cstat-no" title="statement not covered" >			$optionsContainer = $optionNode;</span>
		}
	} );
&nbsp;
 ...
 * @inheritdoc
 */
OO.ui.DropdownInputWidget.prototype.focus = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >	this.dropdownWidget.focus();</span>
<span class="cstat-no" title="statement not covered" >	return this;</span>
};
&nbsp;
/**
 * @inheritdoc
 */
OO.ui.DropdownInputWidget.prototype.blur = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >	this.dropdownWidget.blur();</span>
<span class="cstat-no" title="statement not covered" >	return this;</span>
};
&nbsp;</pre></td></tr>
</table></pre>
