...
<html lang="en">
<head>
    <title>Code coverage report for src/widgets/TagMultiselectWidget.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/widgets/</a> TagMultiselectWidget.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">60.4% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>151/250</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">38.51% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>67/174</span>
      </div>
      <div class='fl pad1y space-right2'>
...
851
852
853</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
OO.ui.TagMultiselectWidget = function OoUiTagMultiselectWidget( config ) {
	var inputEvents,
		rAF = window.requestAnimationFrame || <span class="branch-1 cbranch-no" title="branch not covered" >setTimeout,</span>
		widget = this,
		$tabFocus = $( '&lt;span&gt;' )
...
&nbsp;
	this.toggleDraggable(
		config.allowReordering === undefined ?
			true : <span class="branch-1 cbranch-no" title="branch not covered" >!!config.allowReordering</span>
	);
&nbsp;
	this.inputPosition =
		this.constructor.static.allowedInputPositions.indexOf( config.inputPosition ) &gt; -1 ?
			config.inputPosition : 'inline';
	this.allowEditTags = config.allowEditTags === undefined ? true : <span class="branch-1 cbranch-no" title="branch not covered" >!!config.allowEditTags;</span>
...
&nbsp;
	if ( this.hasInput ) {
		<span class="missing-if-branch" title="if path not taken" >I</span>if ( config.inputWidget ) {
<span class="cstat-no" title="statement not covered" >			this.input = config.inputWidget;</span>
		} else {
 ...
 */
OO.ui.TagMultiselectWidget.prototype.onMouseDown = <span class="fstat-no" title="function not covered" >function ( e ) {</span>
 ...
 */
OO.ui.TagMultiselectWidget.prototype.onInputKeyPress = <span class="fstat-no" title="function not covered" >function ( e ) {</span>
<span class="cstat-no" title="statement not covered" >	var stopOrContinue,</span>
...
<span class="cstat-no" title="statement not covered" >			stopOrContinue = this.doInputEnter( e, withMetaKey );</span>
		}
&nbsp;
		// Make sure the input gets resized.
<span class="cstat-no" title="statement not covered" >		setTimeout( this.updateInputSize.bind( this ), 0 );</span>
<span class="cstat-no" title="statement not covered" >		return stopOrContinue;</span>
	}
};
&nbsp;
/**
 ...
 * @return {boolean}
 */
OO.ui.TagMultiselectWidget.prototype.onInputKeyDown = <span class="fstat-no" title="function not covered" >function ( e ) {</span>
<span class="cstat-no" title="statement not covered" >	var movement, direction,</span>
		widget = this,
		withMetaKey = e.metaKey || e.ctrlKey,
		isMovementInsideInput = <span class="fstat-no" title="function not covered" >function ( direction ) {</span>
<span class="cstat-no" title="statement not covered" >			var inputRange = widget.input.getRange(),</span>
				inputValue = widget.hasInput &amp;&amp; widget.input.getValue();
&nbsp;
<span class="cstat-no" title="statement not covered" >			if ( direction === 'forwards' &amp;&amp; inputRange.to &gt; inputValue.length - 1 ) {</span>
<span class="cstat-no" title="statement not covered" >				return false;</span>
			}
&nbsp;
<span class="cstat-no" title="statement not covered" >			if ( direction === 'backwards' &amp;&amp; inputRange.from &lt;= 0 ) {</span>
<span class="cstat-no" title="statement not covered" >				return false;</span>
			}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >			return this.doInputBackspace( e, withMetaKey );</span>
		} else <span class="cstat-no" title="statement not covered" >if ( e.keyCode === OO.ui.Keys.ESCAPE ) {</span>
<span class="cstat-no" title="statement not covered" >			return this.doInputEscape( e );</span>
		} else <span class="cstat-no" title="statement not covered" >if (</span>
			e.keyCode === OO.ui.Keys.LEFT ||
			e.keyCode === OO.ui.Keys.RIGHT
		) {
<span class="cstat-no" title="statement not covered" >			if ( OO.ui.Element.static.getDir( this.$element ) === 'rtl' ) {</span>
<span class="cstat-no" title="statement not covered" >				movement = {</span>
					left: 'forwards',
					right: 'backwards'
				};
			} else {
...
<span class="cstat-no" title="statement not covered" >			direction = e.keyCode === OO.ui.Keys.LEFT ?</span>
				movement.left : movement.right;
&nbsp;
<span class="cstat-no" title="statement not covered" >			if ( !this.hasInput || !isMovementInsideInput( direction ) ) {</span>
<span class="cstat-no" title="statement not covered" >				return this.doInputArrow( e, direction, withMetaKey );</span>
			}
		}
	}
};
 ...
 */
OO.ui.TagMultiselectWidget.prototype.onInputFocus = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >	this.$element.addClass( 'oo-ui-tagMultiselectWidget-focus' );</span>
};
&nbsp;
/**
 * Respond to input blur event
 */
OO.ui.TagMultiselectWidget.prototype.onInputBlur = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >	this.$element.removeClass( 'oo-ui-tagMultiselectWidget-focus' );</span>
};
&nbsp;
/**
 ...
 * @return {boolean} Whether to prevent defaults
 */
OO.ui.TagMultiselectWidget.prototype.doInputEnter = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >	this.addTagFromInput();</span>
<span class="cstat-no" title="statement not covered" >	return false;</span>
};
&nbsp;
/**
 ...
 * @return {boolean} Whether to prevent defaults
 */
OO.ui.TagMultiselectWidget.prototype.doInputBackspace = <span class="fstat-no" title="function not covered" >function ( e, withMetaKey ) {</span>
<span class="cstat-no" title="statement not covered" >	var items, item;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >	if (</span>
...
<span class="cstat-no" title="statement not covered" >		item = items[ items.length - 1 ];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >		if ( !item.isDisabled() ) {</span>
<span class="cstat-no" title="statement not covered" >			this.removeItems( [ item ] );</span>
			// If Ctrl/Cmd was pressed, delete item entirely.
			// Otherwise put it into the text field for editing.
<span class="cstat-no" title="statement not covered" >			if ( !withMetaKey ) {</span>
<span class="cstat-no" title="statement not covered" >				this.input.setValue( item.getData() );</span>
			}
		}
&nbsp;
<span class="cstat-no" title="statement not covered" >		return false;</span>
 ...
 * @param {jQuery.Event} e Event data
 */
OO.ui.TagMultiselectWidget.prototype.doInputEscape = <span class="fstat-no" title="function not covered" >function () {</span>
 ...
 *  a meta key like 'ctrl'
 */
OO.ui.TagMultiselectWidget.prototype.doInputArrow = <span class="fstat-no" title="function not covered" >function ( e, direction ) {</span>
<span class="cstat-no" title="statement not covered" >	if (</span>
		this.inputPosition === 'inline' &amp;&amp;
		!this.isEmpty() &amp;&amp;
		direction === 'backwards'
 ...
 */
OO.ui.TagMultiselectWidget.prototype.onTagSelect = <span class="fstat-no" title="function not covered" >function ( item ) {</span>
<span class="cstat-no" title="statement not covered" >	if ( this.hasInput &amp;&amp; this.allowEditTags &amp;&amp; !item.isFixed() ) {</span>
<span class="cstat-no" title="statement not covered" >		if ( this.input.getValue() ) {</span>
<span class="cstat-no" title="statement not covered" >			this.addTagFromInput();</span>
		}
 ...
 * @param {OO.ui.TagItemWidget} item Selected item
 */
OO.ui.TagMultiselectWidget.prototype.onTagFixed = <span class="fstat-no" title="function not covered" >function ( item ) {</span>
...
<span class="cstat-no" title="statement not covered" >		if ( items[ i ] !== item &amp;&amp; !items[ i ].isFixed() ) {</span>
<span class="cstat-no" title="statement not covered" >			break;</span>
		}
	}
<span class="cstat-no" title="statement not covered" >	this.addItems( item, i );</span>
};
/**
...
&nbsp;
	<span class="missing-if-branch" title="if path not taken" >I</span>if ( this.hasInput &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.input </span>) {
<span class="cstat-no" title="statement not covered" >		this.input.setDisabled( !!isDisabled );</span>
	}
&nbsp;
	<span class="missing-if-branch" title="if path not taken" >I</span>if ( this.items ) {
<span class="cstat-no" title="statement not covered" >		this.getItems().forEach( <span class="fstat-no" title="function not covered" >function ( item ) {</span></span>
<span class="cstat-no" title="statement not covered" >			item.setDisabled( !!isDisabled );</span>
		} );
	}
};
&nbsp;
 ...
 */
OO.ui.TagMultiselectWidget.prototype.onTagRemove = <span class="fstat-no" title="function not covered" >function ( item ) {</span>
<span class="cstat-no" title="statement not covered" >	this.removeTagByData( item.getData() );</span>
};
&nbsp;
/**
 ...
 */
OO.ui.TagMultiselectWidget.prototype.onTagNavigate = <span class="fstat-no" title="function not covered" >function ( item, direction ) {</span>
<span class="cstat-no" title="statement not covered" >	var firstItem = this.getItems()[ 0 ];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >	if ( direction === 'forwards' ) {</span>
<span class="cstat-no" title="statement not covered" >		this.getNextItem( item ).focus();</span>
	} else <span class="cstat-no" title="statement not covered" >if ( !this.inputPosition === 'inline' || item !== firstItem ) {</span>
		// If the widget has an inline input, we want to stop at the starting edge
		// of the tags
<span class="cstat-no" title="statement not covered" >		this.getPreviousItem( item ).focus();</span>
	}
};
&nbsp;
/**
 ...
 */
OO.ui.TagMultiselectWidget.prototype.addTagFromInput = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >	var val = this.input.getValue(),</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >	if ( isValid || this.allowDisplayInvalidTags ) {</span>
<span class="cstat-no" title="statement not covered" >		this.addTag( val );</span>
<span class="cstat-no" title="statement not covered" >		this.clearInput();</span>
<span class="cstat-no" title="statement not covered" >		this.focus();</span>
	}
};
 ...
 * Clear the input
 */
OO.ui.TagMultiselectWidget.prototype.clearInput = <span class="fstat-no" title="function not covered" >function () {</span>
 ...
 */
OO.ui.TagMultiselectWidget.prototype.addAllowedValue = <span class="fstat-no" title="function not covered" >function ( value ) {</span>
<span class="cstat-no" title="statement not covered" >	if ( this.allowedValues.indexOf( value ) === -1 ) {</span>
<span class="cstat-no" title="statement not covered" >		this.allowedValues.push( value );</span>
	}
};
&nbsp;
/**
 ...
 * @param {string|Object} data Tag data
 */
OO.ui.TagMultiselectWidget.prototype.removeTagByData = <span class="fstat-no" title="function not covered" >function ( data ) {</span>
<span class="cstat-no" title="statement not covered" >	var item = this.findItemFromData( data );</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >	this.removeItems( [ item ] );</span>
};
&nbsp;
...
&nbsp;
	<span class="missing-if-branch" title="if path not taken" >I</span>if ( item === undefined || itemIndex === -1 ) {
...
OO.ui.TagMultiselectWidget.prototype.updateInputSize = function () {
	...
	if ( this.inputPosition === 'inline' &amp;&amp; !this.isDisabled() ) {
		<span class="missing-if-branch" title="else path not taken" >E</span>if ( this.input.$input[ 0 ].scrollWidth === 0 ) {
...
<span class="cstat-no" title="statement not covered" >		this.input.$input.css( 'width', '1em' );</span>
...
<span class="cstat-no" title="statement not covered" >			this.input.setValue( this.input.$input.attr( 'placeholder' ) );</span>
<span class="cstat-no" title="statement not covered" >			this.contentWidthWithPlaceholder = this.input.$input[ 0 ].scrollWidth;</span>
<span class="cstat-no" title="statement not covered" >			this.input.setValue( '' );</span>
&nbsp;
		}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >		currentWidth = this.input.$input.width();</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >		this.input.$input.width( Math.floor( bestWidth ) );</span>
<span class="cstat-no" title="statement not covered" >		this.updateIfHeightChanged();</span>
	} else {
		this.updateIfHeightChanged();
	}
...
OO.ui.TagMultiselectWidget.prototype.toggleValid = function ( valid ) {
	valid = valid === undefined ? <span class="branch-0 cbranch-no" title="branch not covered" >!this.valid </span>: !!valid;
&nbsp;
	if ( this.valid !== valid ) {
		this.valid = valid;
&nbsp;
