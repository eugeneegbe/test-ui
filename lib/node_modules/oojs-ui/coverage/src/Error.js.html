 ...
 */
OO.ui.Error = <span class="fstat-no" title="function not covered" >function OoUiError( message, config ) {</span>
	// Allow passing positional parameters inside the config object
<span class="cstat-no" title="statement not covered" >	if ( OO.isPlainObject( message ) &amp;&amp; config === undefined ) {</span>
<span class="cstat-no" title="statement not covered" >		config = message;</span>
<span class="cstat-no" title="statement not covered" >		message = config.message;</span>
	}
&nbsp;
...
&nbsp;
	// Properties
<span class="cstat-no" title="statement not covered" >	this.message = message instanceof jQuery ? message : String( message );</span>
<span class="cstat-no" title="statement not covered" >	this.recoverable = config.recoverable === undefined || !!config.recoverable;</span>
<span class="cstat-no" title="statement not covered" >	this.warning = !!config.warning;</span>
};
&nbsp;
/* Setup */
&nbsp;
 ...
 */
OO.ui.Error.prototype.isRecoverable = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >	return this.recoverable;</span>
};
&nbsp;
/**
 ...
 */
OO.ui.Error.prototype.isWarning = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >	return this.warning;</span>
};
&nbsp;
/**
 ...
 */
OO.ui.Error.prototype.getMessage = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >	return this.message instanceof jQuery ?</span>
		this.message.clone() :
 ...
 */
OO.ui.Error.prototype.getMessageText = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >	return this.message instanceof jQuery ? this.message.text() : this.message;</span>
};
&nbsp;</pre></td></tr>
</table></pre>
