  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>58/76</span>
      </div>
      <div class='fl pad1y space-right2'>
 ...
 */
OO.ui.Dialog.prototype.onDialogKeyDown = <span class="fstat-no" title="function not covered" >function ( e ) {</span>
<span class="cstat-no" title="statement not covered" >	var actions;</span>
<span class="cstat-no" title="statement not covered" >	if ( e.which === OO.ui.Keys.ESCAPE &amp;&amp; this.constructor.static.escapable ) {</span>
<span class="cstat-no" title="statement not covered" >		this.executeAction( '' );</span>
...
<span class="cstat-no" title="statement not covered" >		e.stopPropagation();</span>
	} else <span class="cstat-no" title="statement not covered" >if ( e.which === OO.ui.Keys.ENTER &amp;&amp; ( e.ctrlKey || e.metaKey ) ) {</span>
<span class="cstat-no" title="statement not covered" >		actions = this.actions.get( { flags: 'primary', visible: true, disabled: false } );</span>
<span class="cstat-no" title="statement not covered" >		if ( actions.length &gt; 0 ) {</span>
<span class="cstat-no" title="statement not covered" >			this.executeAction( actions[ 0 ].getAction() );</span>
<span class="cstat-no" title="statement not covered" >			e.preventDefault();</span>
<span class="cstat-no" title="statement not covered" >			e.stopPropagation();</span>
		}
	}
 ...
 */
OO.ui.Dialog.prototype.onActionClick = <span class="fstat-no" title="function not covered" >function ( action ) {</span>
<span class="cstat-no" title="statement not covered" >	if ( !this.isPending() ) {</span>
<span class="cstat-no" title="statement not covered" >		this.executeAction( action.getAction() );</span>
	}
};
&nbsp;
/**
...
OO.ui.Dialog.prototype.onActionsChange = function () {
	...
	if ( !this.isClosing() ) {
		this.attachActions();
		<span class="missing-if-branch" title="if path not taken" >I</span>if ( !this.isOpening() ) {
 ...
 */
OO.ui.Dialog.prototype.getActions = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >	return this.actions;</span>
};
&nbsp;
/**
 ...
 */
OO.ui.Dialog.prototype.getActionProcess = <span class="fstat-no" title="function not covered" >function ( action ) {</span>
<span class="cstat-no" title="statement not covered" >	return new OO.ui.Process()</span>
	...
	return OO.ui.Dialog.parent.prototype.getSetupProcess.call( this, data )
		.next( function () {
			var config = this.constructor.static,
				...
				title = data.title !== undefined ? <span class="branch-0 cbranch-no" title="branch not covered" >data.title </span>: config.title;
&nbsp;
